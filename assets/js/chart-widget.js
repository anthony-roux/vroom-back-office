...
var cabexcoAdminConfig = window.cabexcoAdminConfig
/*Line chart*/
var optionslinechart = {
    ...
    colors: [cabexcoAdminConfig.primary],
    series: [{
...
var optionslinechart2 = {
    ...
    colors: [cabexcoAdminConfig.secondary],
    series: [{
        name: 'series1',
...
var options = {
    ...
    fill: {
        opacity: 1,
        colors: [cabexcoAdminConfig.primary, cabexcoAdminConfig.secondary],
        type: 'gradient',
        gradient: {
            shade: 'light',
            type: 'vertical',
...
var optionssaleschart = {
    ...
    colors: [cabexcoAdminConfig.primary, cabexcoAdminConfig.secondary, '#e2c636'],
    chart: {
        height: 320,
        type: 'radar',
        dropShadow: {
...
var optionsuserchart = {
    ...
    colors: [cabexcoAdminConfig.primary, cabexcoAdminConfig.secondary, '#222222', '#e2c636'],
    xaxis: {
        tickAmount: 12,
        type: 'category',
    },
...
var optionscandlestickchart = {
    ...
    plotOptions: {
        candlestick: {
            colors: {
                upward: cabexcoAdminConfig.primary,
                downward: cabexcoAdminConfig.secondary
            }
        }
    },
    fill: {

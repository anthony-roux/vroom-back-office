...
(function ($) {
    ...
    var layout = window.localStorage.getItem("page-wrapper") || 'compact-wrapper compact-sidebar';
    ...
    function compactLayout() {
        window.localStorage.setItem('page-wrapper', 'page-wrapper compact-wrapper compact-sidebar');
        window.localStorage.setItem('page-body-wrapper', 'sidebar-icon');
    }
    ...
    $("body").on('click', '#modern-demo', function () {
        window.localStorage.setItem('page-wrapper', 'page-wrapper compact-wrapper modern-sidebar');
        window.localStorage.setItem('page-body-wrapper', 'sidebar-icon');
    });

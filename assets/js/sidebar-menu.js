...
(function ($) {
    ...
    // $(window).on("load", function () {
        $("body .page-wrapper").attr("class", "page-wrapper " + window.cabexcoAdminConfig.layout);
        $("body .page-body-wrapper").attr("class", "page-body-wrapper " + localStorage.getItem("page-body-wrapper"));
        if (localStorage.getItem("page-wrapper") === null) {
            ...
            if ($('body #pageWrapper').hasClass('compact-wrapper')) {
                jQuery('body .submenu-title').append('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
                jQuery('body').on('click', '.submenu-title', function () {
                    jQuery('body .submenu-title').removeClass('active');
                    jQuery('body .submenu-title').find('div').replaceWith('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
                ...
                jQuery('body .menu-title').append('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
                jQuery('body').on('click', ' .menu-title', function () {
                    jQuery('body .menu-title').removeClass('active');
                    jQuery('body .menu-title').find('div').replaceWith('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
                ...
                if ((contentwidth) < '992') {
                    $('body #pageWrapper').removeClass('horizontal-wrapper').addClass('compact-wrapper');
                    $('body .page-body-wrapper').removeClass('horizontal-menu').addClass('sidebar-icon');
                    jQuery('body .submenu-title').append('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');
                    jQuery('body').on('click', '.submenu-title', function () {
                        jQuery('body .submenu-title').removeClass('active');
                        jQuery('body .submenu-title').find('div').replaceWith('<div class="according-menu"><i class="fa fa-angle-right"></i></div>');

...
(function ($) {
    ...
    // $(document).load( function () {
        ...
        if (localStorage.getItem("primary") != null) {
            window.document.documentElement.style.setProperty('--theme-deafult', localStorage.getItem("primary"));
        }
        if (localStorage.getItem("secondary") != null) {
            window.document.documentElement.style.setProperty('--theme-secondary', localStorage.getItem("secondary"));
        }
        ...
        // var primary = window.document.getElementById("ColorPicker1").value;
        // window.document.getElementById("ColorPicker1").onchange = function () {
        //   primary = this.value;
        //   localStorage.setItem("primary", primary);
        //   window.document.documentElement.style.setProperty('--theme-primary', primary);
        // };

        // var secondary = window.document.getElementById("ColorPicker2").value;
        // window.document.getElementById("ColorPicker2").onchange = function () {
        //   secondary = this.value;
        //   localStorage.setItem("secondary", secondary);
        //   window.document.documentElement.style.setProperty('--theme-secondary', secondary);
        // };

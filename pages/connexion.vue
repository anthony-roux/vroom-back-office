...
.form_davy .inputGroup {
  margin: 0 0 2em;
  padding: 0;
  position: relative;
}
.form_davy .inputGroup:last-of-type {
  margin-bottom: 0;
}
.form_davy label {
  margin: 0 0 12px;
...
.form_davy input[type="email"],
.form_davy input[type="text"],
.form_davy input[type="password"] {
  display: block;
  margin: 0;
  padding: 0 1em 0;
...
.form_davy input[type="email"]:focus,
.form_davy input[type="text"]:focus,
.form_davy input[type="password"]:focus {
  outline: none;
  box-shadow: 0px 2px 10px rgba(0, 0, 0, 0.1);
  border: solid 2px #4eb8dd;
}
/* 
.form_davy input[type='email'], .form_davy input[type="text"] {
...
.form_davy button:hover,
.form_davy button:active {
  background-color: #217093;
}
.form_davy .inputGroup1 .helper {
  position: absolute;
  z-index: 1;
  font-family: inherit;
}
.form_davy .inputGroup1 .helper1 {
  top: 0;
  left: 0;
...
.form_davy .inputGroup1.focusWithText .helper {
